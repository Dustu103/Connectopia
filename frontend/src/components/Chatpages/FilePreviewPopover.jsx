// FilePreviewPopover.js
import React from "react";

const FilePreviewPopover = ({ file, onSend, onCancel, isLoading ,messageInput,setMessageInput}) => {
  const handleChange = (e) => {
    setMessageInput(e.target.value); // Use setMessageInput to update the state
  };

  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex justify-center items-center">
      <div className="relative bg-white rounded-lg shadow-lg p-4 max-w-md w-full">
        <h4 className="font-semibold mb-2">Preview File</h4>
        <div className="mb-4">
        ...
        <textarea
          ...
          rows="3" value={messageInput} onChange={handleChange}
        />
